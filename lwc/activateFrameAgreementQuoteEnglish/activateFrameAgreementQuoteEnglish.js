...
import { OMNIDEF } from './activateFrameAgreementQuoteEnglish_def.js';
import tmpl from './activateFrameAgreementQuoteEnglish.html';
import tmpl_nds from './activateFrameAgreementQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class activateFrameAgreementQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
